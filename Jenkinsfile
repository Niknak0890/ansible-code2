    ...
    stages{
        ...
        stage('upload artifacts to jfrog'){
            steps{
              ...
              "http://54.175.115.216:8081/artifactory/ansible/ansible-${BUILD_ID}.zip"'
           }
        }
        stage('publish to ansible server'){
            steps{
                ...
                execTimeout: 12000000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', \
